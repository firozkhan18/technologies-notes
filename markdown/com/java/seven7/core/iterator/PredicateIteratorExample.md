# com\java\seven7\core\iterator\PredicateIteratorExample.java

```java
package com.java.seven7.core.iterator;

import com.java.seven7.core.iterator.custom.BiggerThanFivePredicate;
import com.java.seven7.core.iterator.custom.PredicateIterator;

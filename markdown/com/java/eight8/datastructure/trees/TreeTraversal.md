# com\java\eight8\datastructure\trees\TreeTraversal.java
...
class Node5 {
    ...
    */
    public void printLevelOrder() {
        LinkedList<Node5> queue = new LinkedList<>();
        queue.add(this);
        while (queue.size() > 0) {
            Node5 head = queue.remove();

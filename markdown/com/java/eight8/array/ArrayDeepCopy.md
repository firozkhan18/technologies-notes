# com\java\eight8\array\ArrayDeepCopy.java
...
public class ArrayDeepCopy 
{
    ...
    {
        Employee2[] empArr = new Employee2[2];    //Original array
 
        empArr[0] = new Employee2(100, "Lokesh", "Gupta", new Department(1, "HR"));
        empArr[1] = new Employee2(200, "Pankaj", "Kumar", new Department(2, "Finance"));
         
        Employee2[] copiedArray = SerializationUtils.clone(empArr);  //Deep copied array
...
class Employee2 implements Serializable {
    ...
    public Employee2(int id, String fName, String lName, Department department) {
        super();
        this.id = id;

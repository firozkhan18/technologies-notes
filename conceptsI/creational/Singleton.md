...
### Method 2 – Synchronized Implementation || Make getInstance() synchronized to implement Singleton Method Design Pattern
...
### Method 4 – Double Checked Locking || Use “Double Checked Locking” to implement singleton design pattern
...
### Method 5 – Instantiation through Inner Class || Instantiation through inner class || Using class loading concept

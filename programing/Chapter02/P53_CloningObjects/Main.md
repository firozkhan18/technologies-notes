# Chapter02\P53_CloningObjects\Main.java

```java
package Chapter02.P53_CloningObjects;
...
public class Main {
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        System.out.println("\nShallow copy via manual copy:");
        Chapter02.P50_PassReturnMutablesToImmutableClass.shallow.copy.manually.Point point1
                = new Chapter02.P50_PassReturnMutablesToImmutableClass.shallow.copy.manually.Point(5, 5);

        System.out.println("Point 1 (original), (x, y): " + point1.getX() + ", " + point1.getY());
        Chapter02.P50_PassReturnMutablesToImmutableClass.shallow.copy.manually.Point clone1
                = point1.clonePoint();
        point1.setX(10);
        point1.setY(10);
        ...
        System.out.println("\nShallow copy via the clone() method:");
        Chapter02.P50_PassReturnMutablesToImmutableClass.shallow.copy.clone.Point point2
                = new Chapter02.P50_PassReturnMutablesToImmutableClass.shallow.copy.clone.Point(5, 5);

        System.out.println("Point 2 (original), (x, y): " + point2.getX() + ", " + point2.getY());
        Chapter02.P50_PassReturnMutablesToImmutableClass.shallow.copy.clone.Point clone2
                = point2.clone();
        point2.setX(10);
        point2.setY(10);
        ...
        System.out.println("\nShallow copy via constructor:");
        Chapter02.P50_PassReturnMutablesToImmutableClass.shallow.copy.constructor.Point point3
                = new Chapter02.P50_PassReturnMutablesToImmutableClass.shallow.copy.constructor.Point(5, 5);

        System.out.println("Point 3 (original), (x, y): " + point3.getX() + ", " + point3.getY());
        Chapter02.P50_PassReturnMutablesToImmutableClass.shallow.copy.constructor.Point clone3
                = new Chapter02.P50_PassReturnMutablesToImmutableClass.shallow.copy.constructor.Point(point3);
        point3.setX(10);
        point3.setY(10);
        ...
        Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.cloning.Radius radius4
                = new Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.cloning.Radius();
        radius4.setStart(0);
        radius4.setEnd(10);
        Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.cloning.Point point4
                = new Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.cloning.Point(5, 5, radius4);
        ...
        Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.cloning.Point clone4
        ...
        System.out.println("\nDeep copy via SerializationUtils:");
        Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.serialization.Radius radius5
                = new Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.serialization.Radius();
        radius5.setStart(0);
        radius5.setEnd(10);
        Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.serialization.Point point5
                = new Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.serialization.Point(5, 5, radius5);
        ...
        Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.serialization.Point clone5
        ...
        System.out.println("\nDeep copy via serialization helper method:");
        Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.serialization.Radius radius6
                = new Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.serialization.Radius();
        radius6.setStart(0);
        radius6.setEnd(10);
        Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.serialization.Point point6
                = new Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.serialization.Point(5, 5, radius6);
        ...
        Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.serialization.Point clone6
        ...
        Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.serialization.Radius radius7
                = new Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.serialization.Radius();
        radius7.setStart(0);
        radius7.setEnd(10);
        Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.serialization.Point point7
                = new Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.serialization.Point(5, 5, radius7);
        ...
        Chapter02.P50_PassReturnMutablesToImmutableClass.deep.copy.serialization.Point clone7

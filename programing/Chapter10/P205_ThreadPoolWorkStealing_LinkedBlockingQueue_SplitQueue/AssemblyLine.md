# Chapter10\P205_ThreadPoolWorkStealing_LinkedBlockingQueue_SplitQueue\AssemblyLine.java

```java
package Chapter10.P205_ThreadPoolWorkStealing_LinkedBlockingQueue_SplitQueue;

# com\java\eight8\streams\core\predicates\TestPredicates.java

```java
package com.java.eight8.streams.core.predicates;

import java.util.List;
import java.util.function.BiPredicate;
import java.util.function.Predicate;

import com.java.eight8.streams.core.Employee;

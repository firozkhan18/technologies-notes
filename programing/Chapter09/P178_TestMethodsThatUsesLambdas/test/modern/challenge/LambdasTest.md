# Chapter09\P178_TestMethodsThatUsesLambdas\test\modern\challenge\LambdasTest.java

```java
package Chapter09.P178_TestMethodsThatUsesLambdas.test.modern.challenge;
